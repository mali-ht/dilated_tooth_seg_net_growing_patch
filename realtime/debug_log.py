...
realtime/logs/ instead of flooding the terminal. A full run's debug output can then be handed over
...
def setup_logging(tag="mesh_viewer_segmented"):
    """Creates realtime/logs/ if needed and attaches a per-run timestamped FileHandler. Returns
